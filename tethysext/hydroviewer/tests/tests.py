    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this extension:
            Test command: "tethys test -f tethysext.hydroviewer"

        To run all tests in this file:
            Test command: "tethys test -f tethysext.hydroviewer.tests.tests"

        To run tests in the HydroviewerTestCase class:
            Test command: "tethys test -f tethysext.hydroviewer.tests.tests.HydroviewerTestCase"

        To run only the test_if_tethys_platform_is_great function in the HydroviewerTestCase class:
            Test command: "tethys test -f tethysext.hydroviewer.tests.tests.HydroviewerTestCase.test_if_tethys_platform_is_great"
...
class HydroviewerTestCase(TethysTestCase):
    ...
    def test_a_controller(self):
        ...
        response = c.get('/extensions/hydroviewer/foo/')  # The final '/' is essential for all pages/controllers
